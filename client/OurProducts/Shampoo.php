...
<html>
<head>
	<title>NITA | Our range of shampoo product at madagascar grocery | Best Madagascar grocery</title>
...
<body>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<center><h1>This is our <strong>Shampoo</strong> products that our <strong>groceries</strong> sell</h1></center>
		<div>
		<?php 
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<article class="home-prodlist-img"><a href="'.$pName.'-'.$id.'">
										<img alt="'.$pName.'" src="../../image/product/shampoo/'.$picture.'" class="home-prodlist-imgi">
										</a>
