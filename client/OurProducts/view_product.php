...
<html>
<head>
	<title>NITA | <?php echo $pName; ?> | Best Madagascar groceries</title>
...
<body>
	...
	<div style="float: left;">
		...
		<div style="float: right;width: 40%;color: #067165;background-color: #ddd;padding: 10px;">
			<div style="">
				<h1 style="font-size: 25px; font-weight: bold; "><strong><?php echo $pName ?></strong> </h1><hr>
				<h3 style="padding: 20px 0 0 0; font-size: 20px;">Price: <?php echo $price ?>Php</h3><hr>
				<h3 style="padding: 20px 0 0 0; font-size: 22px; ">Pieces: <?php echo $piece ?></h3>
				...
				<div>
					...
					<div id="srcheader">
						...
						<form id="" method="post" action="../orderform.php?poid=<?php echo $pid ?>">
