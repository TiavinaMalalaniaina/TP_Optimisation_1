...
<html>
<head>
	<title>NITA | Our range of hygiene product | Best madagascar grocery</title>
	<meta name="description" content="Elevate your hygiene routine with our curated selection of essential products, conveniently available online in Madagascar! From gentle skincare to top-quality sanitizers, prioritize cleanliness with ease. Explore our hygiene category and embrace a healthier, happier you today!">
...
<body>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<center><h1>This is our <strong>hygiene</strong> products that our <strong>groceries</strong> sell</h1></center>
		<div>
		<?php 
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<article class="home-prodlist-img"><a href="'.$pName.'-'.$id.'">
										<img alt="'.$pName.'" src="../../image/product/hygiene/'.$picture.'" class="home-prodlist-imgi">
										</a>
